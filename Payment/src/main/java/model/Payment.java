...
public class Payment {
	 ...
	 { 
		...
		{ 
			...
			{ 
				...
				output += "<tr><td><input name='hidItemIDSave' type='hidden' value='" + payment_id + "'>"+payment_id+"</td>";
				...
				output += "<td>" + description + "</td>"; 
				 ...
				 // buttons 		
				   output += "<td><input name='btnUpdate' type='button' value='Update' class='btnUpdate btn btn-secondary'></td>"
				 		  ...
				 		  + "<input name='hidItemIDDelete' type='hidden' value='" + payment_id + "'></form></td></tr>";
	...
	public String updatePayment( String Payment_ID, String UserID, String Method, String Status, String Amount, String Date, String Description)
	 {
	...
	String output = ""; 
		...
		{ 
			...
			String query = "SELECT * FROM `payment` WHERE `payment_id` LIKE '"+payment_id+"'"; 
			Statement stmt = con.createStatement(); 
			ResultSet rs = stmt.executeQuery(query); 
			...
			{ 
				...
				String payment = Integer.toString(rs.getInt("payment_id")); 
				String user_id = rs.getString("user_id"); 
				String method = rs.getString("method"); 
				String status = rs.getString("status"); 
				String amount = rs.getString("amount"); 
